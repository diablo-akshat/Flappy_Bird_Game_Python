...
class Pipe:
    def __init__(self, scale_factor, move_speed):
        ...
        self.rect_up.x = 600
        self.rect_down.y = self.rect_up.y - self.pipe_gap - self.rect_up.height
    ...
    def update(self, dt):
        move_amount = int(self.move_speed * dt)
        self.rect_up.x -= move_amount
        self.rect_down.x -= move_amount
